...
func main() {
	debug := true
	sentryClient, _ := logging.GetSentryClientByDSN(os.Getenv("dsn"), debug)
	...
	// [Sentry] 2020/04/15 14:27:40 Integration installed: Modules
	// [Sentry] 2020/04/15 14:27:40 Integration installed: IgnoreErrors
	// {"level":"ERROR","time":"2020-04-15T14:27:40.716083+08:00","logger":"root","msg":"hello sentry!","pid":47015}
